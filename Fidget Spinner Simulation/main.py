...
pygame.display.set_caption("Fidget Spinner Simulator")
...
def show_spinner(angle, color, dark_color):
    ...
    # Sedikit rumus matematika untuk menghitung koordinat setelah berputar
...
def show_info(friction, speed):
    ...
    frictionText = font.render("Gesekan : " + str(friction), True, white)
    speedText = font.render("Tingkat Perubahan Sudut : " + str(speed), True, white)
    keyText = font.render("Panah Kanan = Memutar ke Kanan", True, white)
    keyText2 = font.render("Panah Kiri = Memutar ke Kiri", True, white)
    keyText3 = font.render("Spasi = Mengganti Warna", True, white)
    exitText = font.render("Q = Exit Program", True, white)
    display.blit(speedText, (15, 15))
    display.blit(frictionText, (15, 35))
    display.blit(keyText, (15, 55))
    display.blit(keyText2, (15, 75))
    display.blit(keyText3, (15, 95))
    display.blit(exitText, (15, 115))
...
def spinner():
    ...
    while spin:
        ...
        # Menampilkan Informasi dan Fidget Spinner
